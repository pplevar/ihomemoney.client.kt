...
class ApiIntegrationTest {
    ...
    @Test
    fun `complete user workflow - login and fetch all data`() = runTest {
    ...
    @Test
    fun `workflow should fail gracefully on login failure`() = runTest {
    ...
    @Test
    fun `should handle server errors in middle of workflow`() = runTest {
    ...
    @Test
    fun `multiple sequential requests should maintain token`() = runTest {
        // Arrange - Login
        mockWebServer.enqueue(MockResponse()
            .setResponseCode(200)
            .setBody("""
    ...
    @Test
    fun `should handle empty response lists`() = runTest {
        // Arrange - Login
        mockWebServer.enqueue(MockResponse()
            .setResponseCode(200)
            .setBody("""
    ...
    @Test
    fun `should handle complex nested account structure`() = runTest {
        // Arrange - Login
        mockWebServer.enqueue(MockResponse()
            .setResponseCode(200)
            .setBody("""
    ...
    @Test
    fun `should handle transaction filtering with topCount`() = runTest {
        // Arrange - Login
        mockWebServer.enqueue(MockResponse()
            .setResponseCode(200)
            .setBody("""
