...
class HomemoneyApiClientTest {
    ...
    @Test
    fun `login should handle network error gracefully`() = runTest {
        // Arrange
        val mockResponse = MockResponse()
            .setResponseCode(500)
    ...
    @Test
    fun `getAccountGroups should return account groups`() = runTest {
        // Arrange
        val mockResponse = MockResponse()
            .setResponseCode(200)
            .setBody("""
    ...
    @Test
    fun `getAccounts should flatten account groups into list`() = runTest {
        // Arrange
        val mockResponse = MockResponse()
            .setResponseCode(200)
            .setBody("""
    ...
    @Test
    fun `getCategories should return categories list`() = runTest {
        // Arrange
        val mockResponse = MockResponse()
            .setResponseCode(200)
            .setBody("""
    ...
    @Test
    fun `getTransactions should return transactions with topCount parameter`() = runTest {
        // Arrange
        val mockResponse = MockResponse()
            .setResponseCode(200)
            .setBody("""
    ...
    @Test
    fun `getTransactions should handle null topCount`() = runTest {
        // Arrange
        val mockResponse = MockResponse()
            .setResponseCode(200)
            .setBody("""
    ...
    @Test
    fun `handleResponse should throw exception on unsuccessful response`() = runTest {
        // Arrange
        val mockResponse = MockResponse()
            .setResponseCode(404)
            .setBody("Not Found")
    ...
    @Test
    fun `token should be set after successful login`() = runTest {
        // Arrange
        val mockResponse = MockResponse()
            .setResponseCode(200)
            .setBody("""
