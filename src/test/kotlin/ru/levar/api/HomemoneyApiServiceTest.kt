...
class HomemoneyApiServiceTest {
    ...
    @Test
    fun `login should send correct parameters`() = runTest {
        // Arrange
    ...
    @Test
    fun `getAccountGroups should parse response correctly`() = runTest {
        // Arrange
        val mockResponse = MockResponse()
            .setResponseCode(200)
            .setBody("""
    ...
    @Test
    fun `getCategories should parse response correctly`() = runTest {
        // Arrange
        val mockResponse = MockResponse()
            .setResponseCode(200)
            .setBody("""
    ...
    @Test
    fun `getTransactions should send topCount parameter`() = runTest {
        // Arrange
        val mockResponse = MockResponse()
            .setResponseCode(200)
            .setBody("""
    ...
    @Test
    fun `login should handle error response`() = runTest {
        // Arrange
        val mockResponse = MockResponse()
            .setResponseCode(200)
            .setBody("""
